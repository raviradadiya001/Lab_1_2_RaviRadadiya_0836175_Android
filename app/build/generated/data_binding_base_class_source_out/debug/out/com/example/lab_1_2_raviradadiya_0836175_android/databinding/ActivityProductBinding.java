...
public final class ActivityProductBinding implements ViewBinding {
  ...
  private ActivityProductBinding(@NonNull RelativeLayout rootView, @NonNull ListView lvProduct) {
  ...
  public static ActivityProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProductBinding((RelativeLayout) rootView, lvProduct);
    }
